print("WELCOME TO CURRENCY CONVERTER WHERE YOU CAN CONVERT YOU DESIRED CURRENCY INTO OTHER CURRENCYS'S\n")
...
if(a=="indianrupee"):
    ...
    print("Caadian Dollars=","{:.2f}".format(b*canadiandollars),"$")
